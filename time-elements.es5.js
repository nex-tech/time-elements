...
(function () {
  ...
  var ExtendedTimeElement = function (_HTMLElement) {
    _inherits(ExtendedTimeElement, _HTMLElement);

    function ExtendedTimeElement() {
      _classCallCheck(this, ExtendedTimeElement);

      return _possibleConstructorReturn(this, (ExtendedTimeElement.__proto__ || Object.getPrototypeOf(ExtendedTimeElement)).apply(this, arguments));
    }

    _createClass(ExtendedTimeElement, [{
  ...
  var RelativeTimeElement = function (_ExtendedTimeElement) {
    _inherits(RelativeTimeElement, _ExtendedTimeElement);

    function RelativeTimeElement() {
      _classCallCheck(this, RelativeTimeElement);

      return _possibleConstructorReturn(this, (RelativeTimeElement.__proto__ || Object.getPrototypeOf(RelativeTimeElement)).apply(this, arguments));
    }

    _createClass(RelativeTimeElement, [{
  ...
  var TimeAgoElement = function (_RelativeTimeElement) {
    _inherits(TimeAgoElement, _RelativeTimeElement);

    function TimeAgoElement() {
      _classCallCheck(this, TimeAgoElement);

      return _possibleConstructorReturn(this, (TimeAgoElement.__proto__ || Object.getPrototypeOf(TimeAgoElement)).apply(this, arguments));
    }

    _createClass(TimeAgoElement, [{
      key: 'getFormattedDate',
      value: function getFormattedDate() {
        if (this._date) {
  ...
  var TimeUntilElement = function (_RelativeTimeElement2) {
    _inherits(TimeUntilElement, _RelativeTimeElement2);

    function TimeUntilElement() {
      _classCallCheck(this, TimeUntilElement);

      return _possibleConstructorReturn(this, (TimeUntilElement.__proto__ || Object.getPrototypeOf(TimeUntilElement)).apply(this, arguments));
    }

    _createClass(TimeUntilElement, [{
      key: 'getFormattedDate',
      value: function getFormattedDate() {
        if (this._date) {
          var format = this.getAttribute('format');
  ...
  var LocalTimeElement = function (_ExtendedTimeElement2) {
    _inherits(LocalTimeElement, _ExtendedTimeElement2);

    function LocalTimeElement() {
      _classCallCheck(this, LocalTimeElement);

      return _possibleConstructorReturn(this, (LocalTimeElement.__proto__ || Object.getPrototypeOf(LocalTimeElement)).apply(this, arguments));
    }
